    ...
    <TrainerLayout>
      ...
      >
        <div className="py-1">
          <MenuItem>
            {({ focus }) => (
              <Link to={'/CourseAddTopic'}>
              <a
                href="#"
                className={classNames(focus ? 'bg-green-300 text-gray-900' : 'text-gray-700 bg-green-100', 'block px-4 py-2 text-sm')}
              >
                Kursa Bölüm Ekle
              </a>
              </Link>
          ...
          <MenuItem>
            {({ focus }) => (
              <Link to={'/CourseAddTopic'}>
               <a
                href="#"
                className={classNames(focus ? 'bg-red-300 text-gray-900' : 'text-gray-700 bg-red-100', 'block px-4 py-2 text-sm')}
              >
                Kursu Sil
              </a>
              </Link>
          ...
          {/* <MenuItem>
            {({ focus }) => (
              <a
                href="#"
                className={classNames(focus ? 'bg-blue-300 text-gray-900' : 'text-gray-700 bg-blue-100', 'block px-4 py-2 text-sm')}
              >
                Güncelle
              </a>
            )}
